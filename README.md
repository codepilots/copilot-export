...
| `storage` | Pass the HTML blob to the print preview page |
| `tabs` | Open the PDF print preview tab |
| Host permissions | Fetch auth-cookie-gated images from Microsoft domains |
